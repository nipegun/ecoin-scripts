...
# ----------
#  Script de NiPeGun para iniciar el farmer de chia (Inicia también el harvester, el full_node y la wallet)
# ----------
...
# Notificar inicio de ejecución del script
  echo ""
  echo "  Iniciando el farmer de chia (si es que no está activo)..."
  echo ""
...
# Iniciar el nodo en modo daemon
  # Comprobar en donde está instalado el nodo
    if [ -f "$CarpetaHome"/Cryptos/XCH/chia-blockchain/resources/app.asar.unpacked/daemon/chia ]; then
      ...
      $CarpetaHome/Cryptos/XCH/chia-blockchain/resources/app.asar.unpacked/daemon/chia start farmer
    else
      chmod +x /opt/chia/resources/app.asar.unpacked/daemon/chia 2> /dev/null
      /opt/chia/resources/app.asar.unpacked/daemon/chia start farmer
    fi
