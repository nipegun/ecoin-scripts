...
#
#  Ejecución remota:
#  curl -s https://raw.githubusercontent.com/nipegun/ecoin-scripts/main/crp-minero-resetear-en-root-ei.sh | bash
#-----------------------------------------------------------------------------------------------------------
...
DirCartera="F62FF04B8849C4ADD45CC5980499168A1B8ADF2C329C602443CD34AA97B55727"
...
if [ $OS_VERS == "7" ]; then
  ...
  # Preparar /root/.bash_history
    ...
    echo "curl -s https://raw.githubusercontent.com/nipegun/ecoin-scripts/main/crp-minero-resetear-en-root-ei.sh | bash"                            >> /root/.bash_history
