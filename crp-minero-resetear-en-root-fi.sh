...
#
#  Ejecución remota:
#  curl -s https://raw.githubusercontent.com/nipegun/ecoin-scripts/main/crp-minero-resetear-en-root-fi.sh | bash
#-----------------------------------------------------------------------------------------------------------
...
DirCartera="248C22E649C37C46A03F6A255212CADE2D1569DBB39FC8CEC03A3D6D1F919D22"
