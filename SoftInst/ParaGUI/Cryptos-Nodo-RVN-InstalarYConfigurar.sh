...
# ----------
# Script de NiPeGun para instalar y configurar la cadena de bloques de raven (RVN)
#
# Ejecución remota:
...
echo ""
echo -e "${cColorAzulClaro}  Iniciando el script de instalación de la cadena de bloques de RVN...${cFinColor}"
echo ""
