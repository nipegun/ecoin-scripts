...
if [ $cVerSO == "13" ]; then
  ...
  menu=(dialog --checklist "¿Donde quieres instalar Utopia Messenger?:" 22 76 16)
    opciones=(
      1 "Instalar en ubicación por defecto (/opt)."                   off
        ...
        do
          case $choice in
            ...
            1)
              ...
              # Descargar el paquete .deb de la instalación
                echo ""
              ...
              # Instalar el paquete .deb
                ...
                echo ""
                apt -y install  /root/SoftInst/Cryptos/CRP/utopia-latest.amd64.deb
