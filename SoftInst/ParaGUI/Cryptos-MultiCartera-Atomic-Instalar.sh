...
#  curl -sL https://raw.githubusercontent.com/nipegun/ecoin-scripts/refs/heads/main/SoftInst/ParaGUI/Cryptos-MultiCartera-Atomic-Instalar.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#  curl -sL https://raw.githubusercontent.com/nipegun/ecoin-scripts/refs/heads/main/SoftInst/ParaGUI/Cryptos-MultiCartera-Atomic-Instalar.sh | sed 's-sudo--g' | bash
# ----------
