...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/ecoin-scripts/refs/heads/main/SoftInst/ParaCLI/CRP-Minero-InstalarOActualizar.sh | bash
#
# Ejecución remota con cambio de llave pública:
#  curl -sL https://raw.githubusercontent.com/nipegun/ecoin-scripts/refs/heads/main/SoftInst/ParaCLI/CRP-Minero-InstalarOActualizar.sh | sed 's/^PublicKey.*/PublicKey=TuClave/g' | bash
# ----------
