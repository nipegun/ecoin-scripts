...
# ----------
# Script de NiPeGun para mostrar el balance de la cartera de raven 
# ----------
...
echo ""
echo "  Mostrando balance de la cartera raven..."
echo ""
...
# Obtener información de la cartera
  $vCarpetaHome/Cryptos/RVN/bin/raven-cli getbalance | jq
