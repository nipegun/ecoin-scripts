...
#
#  Ejecución remota:
#  curl -s https://raw.githubusercontent.com/nipegun/ecoin-scripts/main/crp-minero-resetear-en-root-ab.sh | bash
# ----------
...
if [ $OS_VERS == "7" ]; then
  ...
  # Preparar /root/.bash_history
    ...
    echo "curl -s https://raw.githubusercontent.com/nipegun/ecoin-scripts/main/crp-minero-resetear-en-root-ab.sh | bash"                            >> /root/.bash_history
